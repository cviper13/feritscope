...
pub struct FontConfig {
    /// Path to custom font for radar data tags (TTF/OTF)
    /// If not specified or file doesn't exist, uses built-in monospace
    #[serde(default)]
    pub radar_font: Option<String>,
    
    /// Path to custom font for sidebar/UI elements
    #[serde(default)]
    pub ui_font: Option<String>,
    
    /// Font size for radar data tags (overrides display.font_size if set)
    #[serde(default)]
    pub radar_font_size: Option<f32>,
...
fn default_target_scale() -> f32 { 1.0 }
fn default_target_stroke() -> f32 { 2.0 }
fn default_font_size() -> f32 { 12.0 }
fn default_history_length() -> usize { 20 }
fn default_history_dot_size() -> f32 { 2.0 }
fn default_vector_minutes() -> f32 { 3.0 }
fn default_true() -> bool { true }
fn default_false() -> bool { false }

fn default_bg_color() -> String { "#0A0E1A".to_string() }
fn default_target_color() -> String { "#00FF00".to_string() }
fn default_selected_color() -> String { "#FFD700".to_string() }
fn default_emergency_color() -> String { "#FF0000".to_string() }
fn default_tag_color() -> String { "#00FF00".to_string() }
fn default_history_color() -> String { "#00AA00".to_string() }
fn default_vector_color() -> String { "#0088FF".to_string() }
fn default_ground_color() -> String { "#888888".to_string() }

fn default_tag_offset() -> (f32, f32) { (15.0, -10.0) }
fn default_line_spacing() -> f32 { 14.0 }
fn default_line1() -> String { "{callsign}".to_string() }
fn default_line2() -> String { "F{altitude:03} {gs:03}KT".to_string() }

fn default_fps() -> u32 { 60 }
fn default_max_aircraft() -> usize { 500 }

fn default_ws_url() -> String { "wss://24data.ptfs.app/wss".to_string() }
fn default_api_url() -> String { "https://24data.ptfs.app".to_string() }
